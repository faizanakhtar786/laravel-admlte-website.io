...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#f8f8f8" style="padding-top:20px;"> 
                          ...
                          <tr>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="5" bgcolor="#f8f8f8" style="border:1px solid #eee;">
                              ...
                              <tr>
                                ...
                                <td align="left" valign="top"><a href="#">{{$u_name}}</a></td>
                              </tr>
                             
                              <tr>
                                <td align="right" valign="top"><strong>Mobile:</strong></td>
                                <td align="left" valign="top">{{ $u_mobile }}</td>
                              </tr>
                              <tr>
                                <td align="right" valign="top"><strong>Email:</strong></td>
                                <td align="left" valign="top">{{ $u_email }}</td>
                              </tr>
                              <tr>
                                <td align="right" valign="top"><strong>Message:</strong></td>
                                <td align="left" valign="top"><pre>{{ $u_message }}</pre></td>
                              </tr>
  ...
  <tr>
    <td align="center" valign="top" style="padding:20px 0;"><a href="#">Achal Green Empire</a></td>
  </tr>
</table>
</body>
</html>
